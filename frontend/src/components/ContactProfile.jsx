...
export default function ContactProfile() {
  ...
  return (
    <div>
      <button
        onClick={handleOpen}
        className={`text-black text-sm py-2 px-5 font-semibold transition-transform duration-200 ease-in-out ${
          showProfile
            ? "bg-white border-2 border-gray-300"
            : "bg-gray-200 border-2 border-gray-400 cursor-not-allowed"
        } rounded-3xl shadow-sm hover:border-gray-500`}
